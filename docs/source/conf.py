...
# first_kedro_pipeline documentation build
...
from first_kedro_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "first_kedro_pipeline"
author = "Kedro"
...
htmlhelp_basename = "first_kedro_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "first_kedro_pipeline.tex",
        "first_kedro_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "first_kedro_pipeline",
        "Project first_kedro_pipeline codebase.",
        "Data-Science",
    )
]
